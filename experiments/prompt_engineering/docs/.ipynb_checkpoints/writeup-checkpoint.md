...
- **Decoding:** greedy by default; self-consistency prompts override to `regime: high_div_8` (T=0.8, top_p=0.95, top_k=40, n=8). All prompts share the same `MAX_TOKENS` so accuracy / `pct_boxed` / `avg_tok` are apples-to-apples.
